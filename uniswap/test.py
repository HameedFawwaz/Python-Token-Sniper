...
web3 = Web3(Web3.HTTPProvider("https://mainnet.infura.io/v3/eb8d899d09ac4fd6b440f05beced01bc"))
...
pair_contract = web3.eth.contract(address=uniswap_factory, abi=pair_abi)
swap_contract = web3.eth.contract(address=uniswap_router, abi=swap_abi)
